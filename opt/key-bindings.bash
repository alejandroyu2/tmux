...
# Customize Panes
tmux setw -g pane-border-style fg=green,bg=black
tmux setw -g pane-active-border-style fg=white,bg=black

tmux setw -g window-style fg=colour240,bg=colour235
tmux setw -g window-active-style fg=white,bg=black
...
tmux set -g @plugin 'roosta/tmux-fuzzback'
tmux set -g @plugin 'tmux-plugins/tmux-sidebar'
tmux set -g @plugin 'tmux-plugins/tmux-yank'
tmux set -g @plugin 'laktak/extrakto'

tmux set -g @dracula-show-powerline true
tmux set -g @dracula-show-flags false
tmux set -g @dracula-show-left-icon session
tmux set -g status-position bottom

# dracula customizations
tmux set -g @dracula-plugins "battery time"
tmux set -g @dracula-show-powerline true
tmux set -g @dracula-show-fahrenheit false
tmux set -g @dracula-military-time true
